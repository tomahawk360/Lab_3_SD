...
func main() {
	fulcrum_serv_1, err := grpc.Dial("localhost:50051", grpc.WithInsecure())
	if err != nil {
	...
	fulcrum_serv_2, err := grpc.Dial("localhost:50052", grpc.WithInsecure())
	if err != nil {
	...
	fulcrum_serv_3, err := grpc.Dial("localhost:50053", grpc.WithInsecure())
	if err != nil {
